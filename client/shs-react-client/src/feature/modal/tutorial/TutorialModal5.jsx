import tutorial3 from "../../../asset/tutorial/tutorial3.jpg";
...
function TutorialModal5({ tutorialCount, viewTutorial, setTutorialCount }) {
  return (
    <div className="tutorial w-100 h-100 position-absolute top-50 start-50 translate-middle">
      <div className=" tutorial-2 w-100 shadow bg-light position-absolute top-50 start-50 translate-middle d-flex flex-column justify-content-center align-items-center">
        ...
        <h5 className="w-50 mt-4 mb-5 roboto text-center fw-light">
          Read the question. After reading it, you may choose 1 of the choices
          below. Once you select a button. A "next" button will pop-up below.
        </h5>
        <img className="w-75 mb-5" src={tutorial3} alt="tutorial img" />
        {/* BUTTONS */}
...
export default connect(mapStateToProps, mapDispatchToProps)(TutorialModal5);
